...
export function addMon(id,txtName, sltCountry, txtDescription, txtPhoto, txtVideo) {
    ...
    if (existMon === false) {
        console.log("lol")
        mons.push(new Mon(id,txtName, sltCountry, txtDescription, txtPhoto, txtVideo))
        localStorage.setItem("mons", JSON.stringify(mons))
