...
//1.Resposta à primeira pergunta do primeiro nivel
//1.1 Declaração das variaveis que obtem qual a resposta dada (CorrectAnswer Or WrongAnswer)
const correctAnswerOfOne = document.getElementById("answerOneOfQuestionOne")
const wrongAnswerOfOneA = document.getElementById("answerTwoOfQuestionOne")
const wrongAnswerOfOneB = document.getElementById("answerThreeOfQuestionOne")
...
//2.Resposta à segunda pergunta do primeiro nivel
//2.1 Declaração das variaveis que obtem qual a resposta dada (CorrectAnswer Or WrongAnswer)
const correctAnswerOfTwo = document.getElementById("answerThreeOfQuestionTwo")
const wrongAnswerOfTwoA = document.getElementById("answerOneOfQuestionTwo")
const wrongAnswerOfTwoB = document.getElementById("answerTwoOfQuestionTwo")
...
//3.Resposta à terceira pergunta do primeiro nivel
...
//4.Resposta à quarta pergunta do primeiro nivel
//4.1 Declaração das variaveis que obtem qual a resposta dada (CorrectAnswer Or WrongAnswer)
const correctAnswerOfFour = document.getElementById("answerFourOfQuestionFour")
const wrongAnswerOfFourA = document.getElementById("answerOneOfQuestionFour")
...
correctAnswerOfFour.addEventListener("click", function () {
    ...
    if (score === 4) {
        pOfLevel.innerHTML = `Boa!! Como recompensa recebes 10 Pontos de Experiência e desbloqueaste o Nível 2! <br><br> <input type="button" class="btn" value="Página Inicial" onClick="document.location.reload(true)"> <input type="button" class="btn" value="Proximo Nível" onClick="openQuizzTwo()">`
    }
})
...
function openQuizzTwo() {
    window.open("quizzTwo.html");
  }
